...
<div className='absolute  left-[20px]  xl:left-[117px] z-50 h-[250px]  lg:h-[499px] w-[50%] flex flex-col gap-3 justify-center'>
<div>
<h4 className=' text-primary text-[13px] sm:text-[16px]  md:text-[25px] lg:text-[28px] lg:text-[40px] font-heading font-extrabold w-[220px] md:w-[500px] lg:w-[650px] uppercase'>
Vision
</h4>
<div className='md:text-[13px] text-[8px] top-[40px] lg:text-[23px] text-primary leading-2.5 w-full capitalize left-[20px] md:left-[117px] md:top-[106px] md:leading-6.5'>
...
<div className=' text-[8px] top-[40px] md:text-[13px] lg:text-[23px] text-primary leading-2.5 w-full capitalize  left-[20px] md:left-[117px] md:top-[106px] md:leading-6.5'>
<ul className='disc'>
