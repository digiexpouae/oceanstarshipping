...
<div className='md:text-[13px] text-[8px] top-[40px] lg:text-[19px] xl:text-[23px] text-primary leading-2.5 w-full capitalize left-[20px] md:left-[117px] md:top-[106px] md:leading-6.5'>
...
<div className=' text-[8px] top-[40px] md:text-[13px] lg:text-[19px] xl:text-[23px] text-primary leading-2.5 w-full capitalize  left-[20px] md:left-[117px] md:top-[106px] md:leading-6.5'>
