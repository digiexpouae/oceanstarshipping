...
<div className=' text-primary text-[13px] sm:text-[16px]  md:text-[25px] lg:text-[28px] font-heading font-extrabold w-[65%] md:w-[500px] lg:w-[650px] mb-3 md:mb-5 xl:mb-10 md:leading-7 leading-4 lg:leading-13 uppercase xl:text-[40px] '>Ocean Star is a 
<br />leading electronic 
trading company 
based in the United 
Arab Emirates,
established in 2007</div> 
<div className=' md:text-[16px] text-[8px] top-[40px] lg:text-[20px]  text-primary leading-2.5 w-[85%]   left-[20px] md:left-[117px] md:top-[106px] md:leading-6.5 lowercase'>Over the years, we have built a strong reputation as a trusted provider of high-quality electronic products, catering to both corporate and retail clients across the UAE.</div>
</div>
    </div>
  )
}
