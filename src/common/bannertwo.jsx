...
<div className='w-[85%] relative '><Image  src={poster} layout='responsive' /></div>   
 <div className='absolute left-[10%]  md:left-[10%]  md:h-[200px] md:w-[475px] flex flex-col md:gap-[10px] lg:gap-[30px]'><h3 className='uppercase text-[14px] font-extrabold  md:text-[27px] lg:text-[45px] leading-5 md:leading-9 lg:leading-13 font-heading text-primary'>Get in
<br />Touch For
<br/>Any Queries</h3>
